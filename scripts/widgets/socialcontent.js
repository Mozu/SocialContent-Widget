define(['modules/jquery-mozu', 'underscore', 'modules/api', 'modules/backbone-mozu', 'hyprlivecontext', 'widgets/socialcontent-feed', 'widgets/socialcontent-helpers'],
    function ($, _, Api, Backbone, HyprLiveContext, SocialContentFeeds, SocialContentHelpers) {
        ...
        var getWidgetProperties = function(){
            if(typeof _widgetProperties !== 'object') {
                return _widgetProperties = $('#socialcontent-widget').data('mz-socialcontent');
            }
